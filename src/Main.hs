...
main :: IO ()
main = do
  -- print $ stuffStrikes 1 [1, 4, 4, 5, 6, 4, 5, 5, 10, 0, 1, 7, 3, 6, 4, 10, 2, 8, 6]
  -- print $ stuffStrikes 1 [1, 4, 4, 5, 6, 4, 5, 5, 10, 0, 1, 7, 3, 6, 4, 10, 2, 7]
  -- print $ stuffStrikes 1 [10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10]
